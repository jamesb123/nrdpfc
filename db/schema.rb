...
ActiveRecord::Schema.define(:version => 33) do
  ...
  create_table "country_orig", :force => true do |t|
    t.string "COUNTRY_DESC",    :limit => 35
    t.string "COUNTRY_CODE",    :limit => 2
    t.string "COUNTRY_DESC_FR", :limit => 35
  end

  add_index "country_orig", ["COUNTRY_DESC"], :name => "COUNTRY_DESCR", :unique => true
  add_index "country_orig", ["id"], :name => "COUNTRY_ID"
