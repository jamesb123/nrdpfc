...
ActiveRecord::Schema.define(:version => 20100205165012) do
  ...
  create_table "o_sightings", :force => true do |t|
    t.integer  "survey_id"
    t.datetime "Date"
    t.datetime "Time"
    t.string   "Vessel"
    ...
    t.float    "Sunny"
    t.float    "Foggy"
    t.float    "Mainly cloudy"
    t.float    "Rain"
    t.string   "Latitude"
    t.string   "Longitude"
    t.string   "Sighting By"
    t.string   "Speed min"
    t.string   "Speed max"
    t.string   "Bearing"
    t.string   "SS"
    ...
    t.string   "Closest"
    t.string   "Dspeed"
    t.string   "group comments"
    t.float    "Logging"
    t.float    "Slow (no wake)"
    t.float    "Fast (wake)"
    t.float    "Porpoising"
    t.float    "Chasing"
    t.float    "Breaching"
    t.float    "Surfing"
    t.float    "Fluke-up"
    t.float    "High back arch"
    t.float    "Bow"
    t.float    "Stern"
    t.float    "Synch"
    t.float    "Mostly synch"
    t.float    "Asynch"
    t.float    "Unidir"
    t.float    "Mostly Unidir"
    t.float    "Multidir"
    t.float    "Loose"
    t.float    "Pairs (exc MC)"
    t.float    "Subgroups"
    t.float    "Tight"
    t.string   "structure comments"
    t.float    "Resting"
    t.float    "Travelling"
    t.float    "Feeding"
    t.float    "Play"
    t.float    "Mating/Sexual"
    t.float    "Aggression"
    t.float    "Prey in mouth"
    t.float    "Prey in water"
    t.float    "Prey observed fleeing"
    t.float    "Prey on sonar"
    t.float    "Driftnet"
    t.float    "Sink gillnets"
    t.float    "Trawl"
    t.float    "Pole-fishing"
    t.float    "Commercial"
    t.string   "Vessel comments"
    t.float    "Fish"
    t.float    "Seabirds"
    t.float    "Upwelling"
    t.float    "Weed"
    t.float    "Debris streak"
    t.string   "association comments"
    t.string   "Sonar"
    t.string   "SCY"
    t.string   "Colour-Letter-Code"
    t.string   "general comments"
    t.float    "# ID"
    t.string   "IDs"
    t.string   "ID comments"
  end

  add_index "o_sightings", ["# ID"], :name => "# ID"
  add_index "o_sightings", ["Colour-Letter-Code"], :name => "Colour-Letter-Code"
  add_index "o_sightings", ["ID comments"], :name => "ID comments"
  add_index "o_sightings", ["IDs"], :name => "IDs"

  create_table "o_surveys", :force => true do |t|
  ...
  create_table "sightings", :force => true do |t|
    ...
    t.float    "Surfing"
    t.float    "Fluke_up"
    t.float    "High_back_arch"
    t.float    "Bow"
    t.float    "Stern"
    t.float    "Synch"
    t.float    "Mostly_synch"
    t.float    "Asynch"
    t.float    "Unidir"
    t.float    "Mostly_Unidir"
    t.float    "Multidir"
    t.float    "Loose"
    t.float    "Pairs_exc_MC"
    t.float    "Subgroups"
    t.float    "Tight"
    ...
    t.float    "Feeding"
    t.float    "Play"
    t.float    "Mating_Sexual"
    t.float    "Aggression"
    t.float    "Prey_in_mouth"
    t.float    "Prey_in_water"
    t.float    "Prey_observed_fleeing"
    t.float    "Prey_on_sonar"
    t.float    "Driftnet"
    t.float    "Sink_gillnets"
    t.float    "Trawl"
    t.float    "Pole-fishing"
    t.float    "Commercial"
